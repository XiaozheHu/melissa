function walks = compute_rwr_argumented_sparse(network_files, ngene, gene_clusters, options)
    ...
    if (mustlink_penalty == -1 && cannotlink_penalty == -1)
        ...
        walks = semi_supervised_rwr_argumented_sparse(network_files, ngene, gene_clusters, ...
            restart_prob, mustlink_penalty, cannotlink_penalty);
        % walks = edited_semi_supervised_rwr_argumented(network_files, ngene, gene_clusters, ...
        %     restart_prob, mustlink_penalty, cannotlink_penalty);
    end
